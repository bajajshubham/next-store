...
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || "A modern e-commerce platform built using Next.js, TailwindCSS, Typescript, ShadCN, Stripe, Prisma and PostgreSQL"

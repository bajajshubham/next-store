...
const OrderDetailsTable = ({ order, stripeClientSecret, paypalClientId, isAdmin }: { order: Order, stripeClientSecret: string | null, paypalClientId: string, isAdmin: boolean }) => {
  const {
    shippingAddress,
    shippingPrice,
    orderItems,

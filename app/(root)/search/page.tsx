    ...
    <div className='grid md:grid-cols-5 md:gap-5'>
      ...
      <div className='md:col-span-4 space-y-4'>
        <div className='flex items-center'>
          {q !== 'all' && q !== '' && <Badge className='mx-1'>Query: + {q}</Badge>}
          {category !== 'all' && category !== '' && <Badge className='mx-1'>Category: {category}</Badge>}
          {price !== 'all' && <Badge className='mx-1'>Price: {price}</Badge>}
          {rating !== 'all' && <Badge className='mx-1'>Rating: {rating} & up</Badge>}

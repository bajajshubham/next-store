...
const SignUpForm = () => {
  ...
  const SignUpButton = () => {
    ...
    return <Button disabled={pending} className="w-full" variant={"default"}>{pending ? 'Submitting...' : 'Sign Up'}</Button>
  }
  return (
    <form action={action}>
      ...
      <div className="space-y-6">
        <div>
          ...
          <Input id="name" name="name" type="text"  autoComplete="name" defaultValue={""} />
        </div>
        <div>
          <Label className="mb-2" htmlFor="email">Email</Label>
          <Input id="email" name="email" type="text"  autoComplete="email" defaultValue={""} />
        </div>
        <div>
        ...
        <div>
          ...
          <Input id="confirmPassword" name="confirmPassword" type="password" required autoComplete="confirm Password" defaultValue={""} />
        </div>
        <div>
          <SignUpButton />
        </div>
